...
Route::prefix('v1')->name('api.v1.')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        Route::get('/transactions', [TransactionController::class, 'index'])->middleware('abilities:read')->name('transactions.index');
        Route::post('/transactions', [TransactionController::class, 'store'])->middleware(['abilities:create', 'json.body'])->name('transactions.store');
        Route::get('/transactions/{transaction}', [TransactionController::class, 'show'])->middleware('abilities:read')->name('transactions.show');
        ...
        Route::get('/categories', [CategoryController::class, 'index'])->middleware('abilities:read')->name('categories.index');
        Route::post('/categories', [CategoryController::class, 'store'])->middleware(['abilities:create', 'json.body'])->name('categories.store');
        Route::get('/categories/{category}', [CategoryController::class, 'show'])->middleware('abilities:read')->name('categories.show');
